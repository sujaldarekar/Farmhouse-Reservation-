  ...
  return (
    <div className="pt-32 pb-20 px-6 max-w-7xl mx-auto">
      <motion.div 
        ...
        className="mb-16"
      >
        <h1 className="text-5xl font-bold mb-4 tracking-tight">Our Farmhouse Plans</h1>
        <p className="text-white/60 text-lg">Choose the perfect plan for your gateway.</p>
      </motion.div>
